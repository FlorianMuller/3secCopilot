...
INSERT INTO `__new_videos_metadata`("video_id", "video_original_date", "assigned_to_date", "is_selected", "trim_start_time", "trim_end_time", "is_hidden") SELECT "video_id", "video_original_date", "assigned_to_date", "is_selected", "trim_start_time", "trim_end_time", "is_hidden" FROM `videos_metadata`;--> statement-breakpoint
